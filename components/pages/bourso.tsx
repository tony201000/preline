        ...
        <div className="max-w-2xl">
          ...
          <div className="space-y-5 md:space-y-8">
            ...
            <p className="text-lg text-gray-800 dark:text-neutral-200">
              ...
              sans engagement. L&apos;offre de Boursorama est divisée en 3
              parties. L&apos;ordre doit être respecté pour bénéficier de
              l&apos;ensemble des primes, mais vous pouvez aussi choisir de ne
              pas bénéficier de certaines primes si vous le souhaitez. Vous
              pouvez par exemple bénéficier de l&apos;offre de bienvenue sans
              condition 1, et ensuite décider de ne pas bénéficier des autres
              primes.
            </p>
            <p className="text-lg text-gray-800 dark:text-neutral-200">
              1- Une prime de bienvenue de 70&euro; offerte pour toute ouverture
              de compte sans condition ! Pas besoin de déposer de l&apos;argent
              ou d&apos;utiliser le compte. Pour un compte 100% gratuit et sans
              conditions, choisissez l&apos;option sans carte bancaire ou
              l&apos;option avec carte virtuelle. Les cartes physiques sont
              gratuites sous condition d&apos;utilisation mensuelle.
            </p>
            <p className="text-lg text-gray-800 dark:text-neutral-200">
              2- Une prime de 80&euro; offerte pour tout dépôt de 300&euro;
              minimum sur le compte, ou de 40&euro; pour tout dépôt entre
              50&euro; et 299&euro;. L&apos;argent est à vous et peut être
              retiré à tout moment, sans frais. C&apos;est comme si vous faisiez
              un virement de votre compte courant vers votre livret A.
            </p>
            <p className="text-lg text-gray-800 dark:text-neutral-200">
              3- Une prime de 70&euro; offerte pour toute souscription au
              service gratuit EasyMove qui permet de domicilier automatiquement
              vos prélèvements et virements récurrents de votre ancien compte
              vers votre nouveau compte Boursorama.
            </p>
            {/* début galerie */}
              ...
              <div className="flex items-center">
                ...
                <div className="flex overflow-hidden w-full">
                  ...
                  {currentIndex + 3 > images.length &&
                    images
                      .slice(0, (currentIndex + 3) % images.length)
                      .map((image, index) => (
                        <div
