...
const FaqModele: React.FC<FaqModeleProps> = ({ id, question, children }) => {
  ...
  return (
    <div className={`hs-accordion ${isOpen ? 'hs-accordion-active:bg-gray-100 dark:hs-accordion-active:bg-white/10' : ''} rounded-xl p-6`} id={id}>
      <button
      ...
      <div
        ...
        aria-labelledby={id}
      >
        <div className="mt-2 text-gray-600 dark:text-neutral-400">{children}</div>
      </div>
    </div>
  );
};
